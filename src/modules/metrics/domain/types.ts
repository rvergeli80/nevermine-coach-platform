...
export interface Sport {
  ...
  status: EntityStatus;
  /**
   * FEATURE-002.4: SportSpace propietario. Es la unidad de aislamiento y la
   * única base de autorización (Membership + RLS). `ownerId` se conserva como
   * dato histórico y no interviene en permisos.
   */
